...
String cui1=request.getParameter("cui12");
String fec1=request.getParameter("fec12");
...
String cadenita="DELETE FROM publicacion where email='"+emi+"' and cuil='"+cui1+"'and fecha='"+fec1+"' ";
try
{
