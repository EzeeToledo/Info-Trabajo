...
String cadenaSQL="UPDATE usuario SET lugnac='"+loc+"',direccion='"+dir+"',tel='"+tel+"',cp='"+cp+"',paisor='"+nac+"',estciv='"+num+"',descr='"+des+"' WHERE email='"+oso+"';";
try
{
...
%>
<jsp:forward page="perfilj.jsp"></jsp:forward>
</body>
</html>